      ...
      <Dialog open={isModalOpen} onClose={closeModal} className="fixed z-10 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="bg-white rounded-lg p-4 w-[90vw]">
            <div className="text-lg font-bold mb-4">Create New Discussion</div>
            <input
              type="text"
              name="title"
            ...
            <button onClick={handleSubmit} className="px-4 py-2 bg-black  text-white rounded-lg">Post</button>
